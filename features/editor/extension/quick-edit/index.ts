...
export const showQuickEditEffect = StateEffect.define<boolean | null>();
    ...
    return [
        {
            ...
            create() {
                ...
                form.onsubmit = async (e) => {
                    ...
                    const editedCode = await fetcher({ selectedCode, fullCode, instruction }, currentAbortController.signal)
...
const quickEditTooltipFeild = StateField.define<readonly Tooltip[]>({
    create(state) {
