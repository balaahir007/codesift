...
import z from "zod"
const suggestionRequestionSchema = z.object({
    fileName: z.string(),
    code: z.string(),
...
type SuggestionRequest = z.infer<typeof suggestionRequestionSchema>
...
export const fetcher = async (
    ...
    try {
        const validatePayload = suggestionRequestionSchema.parse(payload)
