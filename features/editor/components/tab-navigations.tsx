...
import { useFile } from "@/features/components/projects/hooks/use-files";
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
            "p-0.5 rounded-md hover:bg-white/10 opacity-0 group-hover:opacity-100 ",
...
export const TabNavigation = ({ projectId }: { projectId: Id<"projects"> }) => {
