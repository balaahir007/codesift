                ...
                mockInterviewData.map((interview, index) => (
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between mt-4">
                            ...
                            <button className="px-4 py-1.5 cursor-pointer text-sm font-medium text-[#2ab3af] bg-white border border-[#2ab3af] rounded-md hover:bg-[#2ab3af] hover:text-white transition-all duration-200 shadow-sm">
                                View Interview
                            </button>
                        </div>
                    </div>
