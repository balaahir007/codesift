...
router.get('/:courseId/progress/chapter/:chapterId', protectRoute, getChapterProgress); // Specific chapter progress
...
// chapters
router.post('/:courseId/chapter', protectRoute, authorize(['admin']), uploadVideo.single('video'), addChapter);
router.get('/:courseId/attachments', protectRoute, getAllAttachMents);
router.patch('/:courseId/chapter/:chapterId/reorder', protectRoute, authorize(['admin']), reorderChapter);

// assignments routes
router.get("/assignments/:courseId", protectRoute, getCourseAssignments);

// Get assignment details (also used for results)
router.get("/assignments/:assignmentId", protectRoute, getAssignmentById);
...
router.post("/assignments/:assignmentId/submit", protectRoute, submitAssignment);
...
router.get("/certificate/:certificateId/download", protectRoute, downloadCertificate);
router.post("/certificate/:certificateId/share", protectRoute, shareCertificate);
